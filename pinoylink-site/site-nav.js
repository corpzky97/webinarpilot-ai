(()=>{
  ...
  wrap.innerHTML=`<button type="button" data-site-back aria-label="Go back">← Back</button><a href="/" aria-label="Go to PinoyLink home">Home</a><a class="site-utility" href="/events?utm_source=site_nav&utm_medium=community&utm_campaign=pinoylink_growth">Events</a><a class="site-utility" href="/jobs?utm_source=site_nav&utm_medium=community&utm_campaign=pinoylink_growth">Jobs</a><a class="site-invite" href="${invite}" aria-label="Join or invite someone to PinoyLink">Join / Invite</a><button type="button" data-site-forward aria-label="Go forward">Forward →</button>`;
  ...
  style.textContent='.site-history-nav{position:fixed;left:50%;bottom:max(14px,env(safe-area-inset-bottom));transform:translateX(-50%);z-index:120;display:flex;gap:7px;align-items:center;padding:8px;border:1px solid #ffffff24;border-radius:999px;background:#04101aee;backdrop-filter:blur(14px);box-shadow:0 14px 40px #0008;max-width:calc(100vw - 18px);overflow-x:auto}.site-history-nav button,.site-history-nav a{min-height:42px;border-radius:999px;border:1px solid #ffffff22;background:#0d2638;color:#f7fbff;padding:10px 13px;font:700 13px Manrope,sans-serif;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;cursor:pointer;white-space:nowrap}.site-history-nav a[href="/"]{background:#153247}.site-history-nav .site-utility{background:#0d2d3e;color:#d9f8ff}.site-history-nav .site-invite{background:linear-gradient(135deg,#ffe398,#f5b936);color:#06131f;border:0}.site-history-nav button:focus-visible,.site-history-nav a:focus-visible{outline:3px solid #9ff3ff;outline-offset:2px}.post-signup-invite{margin:14px 0 4px;padding:16px;border:1px solid #f5c85a66;border-radius:16px;background:linear-gradient(135deg,#f5c85a12,#54d8e718);display:grid;gap:8px}.post-signup-invite strong{color:#ffe398;font-size:1rem}.post-signup-invite span{color:#d7e8ee}.post-signup-invite>div{display:flex;gap:8px;flex-wrap:wrap}.post-signup-invite button,.post-signup-invite a{min-height:42px;border-radius:999px;border:1px solid #ffffff20;padding:9px 13px;font:800 13px Manrope,sans-serif;text-decoration:none;display:inline-flex;align-items:center;justify-content:center;cursor:pointer}.post-signup-invite button:first-child{background:linear-gradient(135deg,#ffe398,#f5b936);color:#06131f;border:0}.post-signup-invite button:nth-child(2),.post-signup-invite a{background:#123247;color:#f4fbff}.post-signup-invite small{color:#9ed8df}@media(max-width:520px){.site-history-nav{gap:5px;padding:6px}.site-history-nav button,.site-history-nav a{padding:9px 10px;font-size:12px}.site-history-nav button{display:none}.post-signup-invite>div>*{flex:1 1 130px}}@media(min-width:900px){.site-history-nav{bottom:18px}}';
