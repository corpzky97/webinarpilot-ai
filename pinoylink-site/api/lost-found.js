...
export default async function handler(req,res){
  ...
  const payload={case_id:caseId,report_type:reportType,item_category:clean(b.item_category,80),item_title:clean(b.item_title,100),description:clean(b.description,900),island:clean(b.island,60),city_area:clean(b.city_area,100),location_detail:clean(b.location_detail,180),event_date:clean(b.event_date,40),contact_name:clean(b.contact_name,100),contact_email:email,contact_phone:clean(b.contact_phone,40),preferred_contact:clean(b.preferred_contact,30),image_url:'',proof_prompt:clean(b.proof_prompt,180),review_status:'pending',public_status:'pending',submitted_at:new Date().toISOString(),published_at:'',resolved_at:'',archived_at:'',archive_reason:'',status:'active'};
